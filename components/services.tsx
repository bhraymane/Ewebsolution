...
function services() {
  ...
  return (
    <div className='h-full flex flex-col justify-center px-6 py-10 items-center bg-mainColor/5 '>
        ...
        className='grid grid-cols-4 max-xl:grid-cols-2 max-md:grid-cols-1 gap-6 mt-10 '>
            {serviceList.map((service,index)=>(
                <Link href={service.url} key={index}   className='bg-white p-6 rounded-xl shadow-xl hover:shadow-2xl hover:bg-mainColor hover:text-white hover:scale-105 transition-all' >
