...
function Hero() {
  return (
    <div className='h-screen max-sm:h-full max-sm:px-0 lg:py-6 max-lg:py-0 px-6 flex max-lg:flex-col max-lg:justify-normal  justify-between '> 
        <div className='relative max-w-[650px] flex flex-col max-sm:px-2  max-lg:items-center max-lg:max-w-full max-lg:text-center max-lg:mt-0 mt-10 max-lg:space-y-10 max-sm:space-y-6 space-y-4 '>
            ...
            <h1 className='text-4xl max-lg:text-white max-lg:text-3xl max-lg:max-w-xl max-lg:leading-16 max-sm:leading-12 max-sm:text-[20px] max-sm:max-w-md font-bold  text-gray-800 leading-12'>Agence Web à <span className='text-mainColor'> <div className='bg-white inline-block px-1 -rotate-3 ' > Marrakech</div></span> Création de Sites, Référencement & Solutions Digitales</h1>
        ...
        <div className='relative max-lg:hidden '>
            <div  className='w-[350px] h-[400px] bg-mainColor max-lg:hidden  absolute -z-20 -left-9 rounded-4xl shadow-2xl'></div>
            ...
            <div className='bg-white/90 max-lg:hidden flex gap-1 justify-center items-center backdrop-filter backdrop-blur-xl absolute text-xs px-3 py-2 font-semibold text-mainColor  shadow-xl -right-2 top-1 rounded-md'>
            <TbDeviceDesktopCode />
            Creation des sites internet  
            </div>
            <div className='bg-white/90 max-lg:hidden flex gap-1 justify-center items-center backdrop-filter backdrop-blur-xl absolute text-xs px-3 py-2 font-semibold text-mainColor  shadow-xl -left-20 top-8 rounded-md'>
            <TbSeo />
            Referencement SEO 
            </div>
            <div className='bg-white/90 max-lg:hidden flex gap-1 justify-center items-center backdrop-filter backdrop-blur-xl absolute text-xs px-3 py-2 font-semibold text-mainColor  shadow-xl -left-28 top-46 rounded-md'>
            <MdDesignServices />
            Creation Graphic 
            </div>
            <div className='bg-white/90 max-lg:hidden flex gap-1 justify-center items-center backdrop-filter backdrop-blur-xl absolute text-xs px-3 py-2 font-semibold text-mainColor  shadow-xl -left-22 top-80 rounded-md'>
            <FaGraduationCap />
            Formation 
            </div>
