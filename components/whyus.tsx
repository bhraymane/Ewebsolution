  ...
  return (
    <div className='h-full flex max-lg:flex-col justify-center px-6 py-10 items-center space-x-4 '>
        <div className='flex-1'>
            ...
            <Link href={"#"} className='bg-mainColor mt-6 inline-block text-white max-sm:text-xs px-3 py-2 rounded-md hover:bg-mainColor/70 transition-all '>               
                    <p>En savoir plus</p>
        ...
        <div className='flex-1 p-10 max-lg:p-0 max-lg:mt-4 space-y-6'>
